...
| Plan | Title | Status |
|---|---|---|
| [0001](plans/0001-ingestor-implementation.md) | FinStream Ingestor implementation | Done |
...
| [0006](plans/0006-instrument-comparison.md) | Percentage comparison of instruments on one chart | In progress |
