...
- **Branches:** work lands on `main` by default. Use `feat/NNNN-<slug>`, `fix/NNNN-<slug>` or `docs/<slug>` when a change should be reviewed or proved by CI first.
